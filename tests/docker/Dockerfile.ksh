...
# Create test user
RUN useradd -m -s /bin/ksh testuser

# Set up basic ksh configuration
COPY --chown=testuser:testuser tests/docker/kshrc.test /home/testuser/.kshrc
...
CMD ["ksh", "/home/testuser/test_script.sh"] 